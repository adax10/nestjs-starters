## NestJS starter with TypeORM (0.3), database MariaDB and Redis
...
```
# redis config
REDIS_HOST=localhost (required string, default localhost)
REDIS_PORT=6379 (required number, default 6379)
REDIS_PREFIX=development|production (optional enum NodeEnv, default development)
```
